...
describe('storeMessage', () => {
  it('stores a message and retrieves it', () => {
    ...
    const messages = getMessagesSince('group@g.us', '2024-01-01T00:00:00.000Z', 'hal');
...
describe('getMessagesSince', () => {
  ...
  it('returns messages after the given timestamp', () => {
    const msgs = getMessagesSince('group@g.us', '2024-01-01T00:00:02.000Z', 'hal');
  ...
  it('excludes bot messages via is_bot_message flag', () => {
    const msgs = getMessagesSince('group@g.us', '2024-01-01T00:00:00.000Z', 'hal');
  ...
  it('filters pre-migration bot messages via content prefix backstop', () => {
    ...
    store({
      ...
      sender_name: 'Bot', content: 'hal: old bot reply',
      timestamp: '2024-01-01T00:00:05.000Z',
    });
    const msgs = getMessagesSince('group@g.us', '2024-01-01T00:00:04.000Z', 'hal');
