...
The badge color reflects what percentage of an LLMs context window the codebase fills (context window size is configurable, defaults to 200k). Green for under 30%, yellow-green for 30%-50%, yellow for 50%-70%, red for 70%+.
